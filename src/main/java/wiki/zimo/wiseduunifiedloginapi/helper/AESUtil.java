...
public class AESUtil {
    ...
    //私钥
    private static final String AES_KEY = "xxxxxxxxx";   //AES固定格式为128/192/256 bits.即：16/24/32bytes。DES固定格式为128bits，即8bytes。
    ...
    public static void main(String[] args) {
        String encrypt = AESUtil.encrypt(null);
