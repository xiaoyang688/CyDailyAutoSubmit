...
public class WeChatUtil {
    ...
    public static JSONObject getAccessToken(String accessToken) {
    ...
    public static void main(String[] args) {
        ...
        String accessToken = "35_Th_tHzyc5tQ5mQAoWV_fNHzZFFFrsPnD992R6IT2uyyW3vmhlarHjn5SzkSbxH4oe5rhWLl9yxbMKVfFNgJdLi01M3SDqlA5R4jfWrqr4r_AqRKetxYSYrtdZgGkAFqNymTWcOyaRV0nQbhJCJRiADAQXF";

        String jsApiTicket = getJsApiTicket(accessToken);
        System.out.println(jsApiTicket);
        Map<String, String> map = generateWxTicket(jsApiTicket, "https://test.xiaoyang666.top");
